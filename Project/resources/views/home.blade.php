...
<!-- Mirrored from agileui.com/demo/bower_components/monarch/demo/admin-template/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Oct 2016 18:25:26 GMT -->
<head>
    ...
    <style>
        ...
        .sidebar-submenu{display:none;padding:0;width:100%;margin:1px 0;list-style:none;border:1px solid transparent;border-radius:3px}

         .user-account-btn>a.user-profile span {
            margin-right: 10px;
            float: left;
...
<title> TEST SupportZebra</title>
<meta name="description" content="">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">

<!-- Favicons -->

<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ asset("/bower_components/monarch/assets/images/icons/apple-touch-icon-144-precomposed.png")}}">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ asset("/bower_components/monarch/assets/images/icons/apple-touch-icon-114-precomposed.png")}}">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ asset("/bower_components/monarch/assets/images/icons/apple-touch-icon-72-precomposed.png")}}">
<link rel="apple-touch-icon-precomposed" href="{{ asset("/bower_components/monarch/assets/images/icons/apple-touch-icon-57-precomposed.png")}}">
<link rel="shortcut icon" href="{{ asset("/bower_components/monarch/assets/images/icons/favicon.png")}}">



    <link rel="stylesheet" type="text/css" href="{{ asset("/bower_components/monarch/assets-minified/admin-all-demo.css")}}">

    <!-- JS Core -->

    <script type="text/javascript" src="{{ asset("/bower_components/monarch/assets-minified/js-core.js")}}"></script>
            ...
            <ul class="chat-box">
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset("/bower_components/monarch/assets/image-resources/people/testimonial1.jpg")}}" alt="">
                ...
                <li>
                    <div class="status-badge">
<img class="img-circle" width="40" src="{{ asset("/bower_components/monarch/assets/image-resources/people/testimonial2.jpg")}}" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Carl Gamble
                ...
                <li>
                    <div class="status-badge">
    <img class="img-circle" width="40" src="{{ asset("/bower_components/monarch/assets/image-resources/people/testimonial3.jpg")}}" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Michael Poole
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset("/bower_components/monarch/assets/image-resources/people/testimonial4.jpg")}}" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Bill Green
                ...
                <li>
                    <div class="status-badge">
             <img class="img-circle" width="40" src="{{ asset("/bower_components/monarch/assets/image-resources/people/testimonial5.jpg")}}" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Cheryl Soucy
            ...
            <ul class="chat-box">
                <li>
                    <div class="status-badge">
        <img class="img-circle" width="40" src="{{ asset("/bower_components/monarch/assets/image-resources/people/testimonial6.jpg")}}" alt="">
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset("/bower_components/monarch/assets/image-resources/people/testimonial7.jpg")}}" alt="">
                        <div class="small-badge bg-orange"></div>
                    </div>
                    <b>
                        Dan Garcia
                ...
                <li>
                    <div class="status-badge">
         <img class="img-circle" width="40" src="{{ asset("/bower_components/monarch/assets/image-resources/people/testimonial8.jpg")}}" alt="">
                        <div class="small-badge bg-orange"></div>
                    </div>
                    <b>
                        Edward Bridges
...
<div id="sidebar-toggle-4" class="collapse in">
    ...
    <div id="mobile-navigation">
        ...
        <a href="index-2.html" class="logo-content-small" title="bower_components/monarchUI"></a>s
    </div>
    <div id="header-logo" class="logo-bg">
       <img src="{{ asset("/bower_components/monarch/img/SUPPORTZEBRA_FINAL.png")}}" width="100%">
    ...
    <div id="header-nav-left">
        <div class="user-account-btn dropdown">
            <a href="#" title="My Account" class="user-profile clearfix" data-toggle="dropdown">
                <img width="28" src="{{ asset("/bower_components/monarch/assets/image-resources/gravatar.jpg")}}" alt="Profile image">
                <span>{{ Session::get('user_fname')}} {{ Session::get('user_lname')}}</span>
                ...
                <div class="box-sm">
                    <div class="login-box clearfix">
                        <div class="user-img">
                            ...
                            <img src="{{ asset("/bower_components/monarch/assets/image-resources/gravatar.jpg")}} " alt="">
                        </div>
                        <div class="user-info">
                            <span>
                    ...
                    <div class="pad5A button-pane button-pane-alt text-center">
                        <a href="{{ URL::asset('logout') }}" class="btn display-block font-normal btn-danger">
...
<div class="scroll-sidebar">
    ...
    <li class="divider"></li>
    <li class="header"><span>SUPPORTZEBRA TOOLS</span></li>
     <li class="divider"></li>
...
<script type="text/javascript" src="{{ asset("/bower_components/monarch/assets-minified/admin-all-demo.js")}}"></script>


</div>
</body>

<!-- Mirrored from agileui.com/demo/bower_components/monarch/demo/admin-template/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Oct 2016 18:26:05 GMT -->
</html>